...
$KEY_PATH = "C:\Users\USERNAME\.ssh\kbo-key.pem"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "========================================" -ForegroundColor Cyan
    Write-Host "`n🌐 대시보드: http://EC2_PUBLIC_IP:8502" -ForegroundColor Green
    Write-Host "🎯 투수 통계 확인: http://EC2_PUBLIC_IP:8502/Player_Stats" -ForegroundColor Green
}
else {
