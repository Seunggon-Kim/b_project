...
# 행 하나가 4로 계상됩니다.
#
# 같은 날 쓰는 다른 작업을 빼고 잡습니다. **매월 1일이 가장 빡빡합니다.**
#
#     monthly   players 1,745행 x (1+인덱스 2)    5,235
#     daily     약                                3,000
#     여유                                        3,765
#     -----------------------------------------------
#     backfill 몫                                88,000  -> 22,000행
#
# 23,000행(92,000)으로 두면 1일 합계가 100,235 라 한도를 235 넘깁니다.
# 실제로 넘겨 보기 전에는 어느 작업이 실패할지 모릅니다. 4일 더 걸리는
# 편이 낫습니다(51일 -> 55일).
DEFAULT_BUDGET_ROWS = 22000
