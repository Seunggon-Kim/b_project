...
const TEAM_COLORS = {
    ...
    // 옛 이름입니다. 위키백과 '야구 주요 색' 틀에 없습니다. 지금
    // 구단의 이전 이름이라 그렇습니다. 계보를 따라 같은 색을 씁니다.
    'SK': '#CE0E2D',
    '넥센': '#570514',
    '히어로즈': '#570514',
    '우리': '#570514',
    ...
    // 없어진 구단입니다. 위키백과 '야구 주요 색' 틀의 '배경색1' 을
    // 그대로 씁니다.
    'MBC': '#1552F8',
    '현대': '#007F55',
    '쌍방울': '#FFC81E',
...
/**
 * 배경색 위에 올릴 글자색입니다. 검정 아니면 흰색입니다.
 *
 * 쌍방울(#FFC81E)과 삼미(#88B7E1)는 밝은 색입니다. 그 위에 흰 글자를
 * 올리면 읽히지 않습니다. WCAG 상대 휘도를 재서 밝으면 검정,
 * 어두우면 흰색을 돌려줍니다.
 */
function textOn(hex) {
    ...
    // 0.179 는 흰 글자와 검은 글자의 대비가 뒤집히는 지점입니다.
